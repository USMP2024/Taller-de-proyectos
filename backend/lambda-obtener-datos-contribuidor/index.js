  ...
  try {
    ...
    const userQuery = `
      SELECT usr.usr_txt_correo_electronico as email, 
             ...
             dtl.dtl.txt_direccion_postal as direccionPostal, 
             dtl.dtl.txt_direccion_complementaria as lineaDireccion, 
             dtl.dtl.txt_ciudad as ciudad, 
             dtl.dtl.int_codigo_postal as codigoPostal, 
             dtl.dtl.txt_pais as país, 
             dtl.dtl.txt_provincia as provincial, 
             dtl.dtl.txt_correo_pago as correoPago, 
             dtl.dtl.txt_pago_minimo as pagoMinimo, 
             dtl.dtl.txt_url_sitio_web as sitioWeb, 
             dtl.dtl.txt_frase_cierre as fraseCierre, 
